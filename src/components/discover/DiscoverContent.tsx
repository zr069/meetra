  ...
  return (
    <div className="max-w-md mx-auto px-4 py-6">
      ...
      <div className="flex items-center justify-center gap-6 mt-6">
        <button
          onClick={handlePass}
          className="w-16 h-16 rounded-full bg-white shadow-lg border border-[var(--border)] flex items-center justify-center hover:scale-110 transition-transform"
        >
        ...
        <button
          ...
          className="w-20 h-20 rounded-full bg-[var(--primary)] shadow-lg flex items-center justify-center hover:scale-110 transition-transform"
        >
